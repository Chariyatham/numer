  ...
  return (
    <div>
      ...
      <FastPath
        minutes={120}
        must={[
          { s: "หมวด 0 · ทำไมต้องเรียน", min: 5, why: "รู้ว่าโจทย์ทุกข้อเริ่มจากการจัดให้เหลือ f(x) = 0" },
          { s: "หมวด 1 · Graphical Method", min: 8, why: "สั้น แต่เป็นการบ้าน 3 ข้อ 1 และใช้สแกนหาช่วงก่อนวิธีอื่น" },
          { s: "หมวด 2 · Bisection", min: 20, why: "วิธีแรกที่ต้องเดินตารางเป็น — กติกาตัดสินใจย้ายฝั่งอยู่ตรงนี้" },
          { s: "หมวด 3 · False Position", min: 15, why: "โครงเดียวกับ Bisection เปลี่ยนแค่บรรทัดคำนวณ" },
          { s: "หมวด 4 · One-point Iteration", min: 20, why: "⭐ ต้องจัด x = g(x) เอง และเช็ค |g′| < 1 — จุดที่คนพลาดมากสุด" },
          { s: "หมวด 5 · Newton-Raphson", min: 20, why: "เร็วสุด ออกบ่อยสุด · ต้อง diff เป็น" },
          { s: "หมวด 6 · Secant", min: 15, why: "ตัวช่วยเมื่อ diff ไม่ได้ · จำบรรทัดเลื่อนตัวแปรให้ได้" },
          { s: "หมวด ∑ · Quick Reference", min: 15, why: "⭐ ตารางกติกาเดินตาราง (รอบทำทิ้ง / สูตร ε) — อ่านซ้ำหลายรอบได้เลย" },
        ]}
        skip={[
          { s: "หมวด 7 · Taylor Series", why: "อยู่ในเอกสารติวแต่ไม่ใช่วิธีหาราก — อ่านทีหลังได้" },
          { s: "หมวด 🏗️ ประยุกต์ + ✸ ข้อสอบจำลอง", why: "ยกไปเฟส 2–3" },
          { s: "ส่วน 📮 การบ้าน 4 / 5", why: "อย่าเพิ่งเปิดเฉลย — เฟส 2 ให้ลองทำเองก่อน" },
        ]}
        check={[
          "บอกได้ว่าวิธีไหนมี “รอบทำทิ้ง” และวิธีไหนคิด error ตั้งแต่รอบ 1",
          "เขียนสูตร ε ของทุกวิธีได้ (ทุกวิธีหารด้วยค่าใหม่)",
          "เจอโจทย์ที่ diff ยากแล้วรู้ทันทีว่าต้องสลับไปใช้ Secant",
        ]}
      />
